...
/**
 * Guarda o hist√≥rico de um jogo, com as posi√ß√µes da mesa jogada a jogada e o
...
public class HistoricoDeJogo {
	...
	/**
	 * Informa que o resultado da partida nesse hist√≥rico foi empate.
	 */
	...
	private class SituacaoNoJogo {
		...
		@Override
		public String toString() {
			return "  " + this.jogador1.getNome() + " : " + jogadaJ1.toString() + ", m„o: " + maoJ1.toString() + "\n  "
					+ this.jogador2.getNome() + " : " + jogadaJ2.toString() + ", m„o: " + maoJ2.toString() + "\n  "
					+ "MESA: " + mesa.toString();
		}
	}
}
